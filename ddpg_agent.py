...
class Agents():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed, fc1_units, fc2_units,
                 BUFFER_SIZE, BATCH_SIZE, GAMMA, TAU, LR_ACTOR, LR_CRITIC, CRITIC_WEIGHT_DECAY):
